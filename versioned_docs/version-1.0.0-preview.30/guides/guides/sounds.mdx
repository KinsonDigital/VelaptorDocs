...
Go to the <a href="https://github.com/KinsonDigital/VelaptorTutorials/tree/api-v1.0.0-preview.30/Sounds" target="_blank" className="link" rel="noopener noreferrer">Sounds<OpenNewTab style={{paddingTop: '10', paddingLeft: '0.25%', width: '2%'}}/></a> tutorial project to see the source code for a fully working example of this guide.
:::
...
<table>
  <tr style={{ border: 'none' }}>
    <td style={{ border: 'none' }}>
		<Audio url="https://github.com/KinsonDigital/VelaptorDocs/raw/main/SampleProjects/Guides/Sounds/Content/Sounds/mario-jump.mp3"
        name="Mario Jump"/>
	</td>
    <td style={{ border: 'none' }}>
        <Audio url="https://github.com/KinsonDigital/VelaptorDocs/raw/main/SampleProjects/Guides/Sounds/Content/Sounds/metroid-ice-beam.mp3"
        name="Metroid Ice Beam"/>
	</td>
    <td style={{ border: 'none' }}>
		<Audio url="https://github.com/KinsonDigital/VelaptorDocs/raw/main/SampleProjects/Guides/Sounds/Content/Sounds/brinstar-music.mp3"
...
sound <OpenLinkNewTab url="https://github.com/KinsonDigital/VelaptorDocs/raw/main/SampleProjects/Guides/Sounds/Content/Sounds/deep-consistency.ogg" linkName="here"/>.

Play it to see if you like it.  😀
<Audio url="https://github.com/KinsonDigital/VelaptorDocs/raw/main/SampleProjects/Guides/Sounds/Content/Sounds/deep-consistency.ogg" />
