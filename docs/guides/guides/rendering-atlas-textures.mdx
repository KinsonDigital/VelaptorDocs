...
:::info JSON
If you are new to **JSON**, click [here](https://www.youtube.com/watch?v=iiADhChRriM) for a great 10-minute video.
:::
...
Create the following class fields which will be used for holding content data, loading content, and rendering content.
...
public class Game : Window
{
    ...
    private ITexture? atlasTexture;  // The atlas texture
}
```

## <span class="color-step">Step 5: Basic setup</span>

In the `Game` class, add the following code to the constructor to set up the window, create a texture renderer, and the batcher.
...
### <span class="color-sub-step">Step 6.1: Load texture atlas content</span>

Next, let's create the `OnLoad()` override method and add code to the method to create an atlas
loader and load the atlas data.
...
### <span class="color-sub-step">Step 6.2: Unload content</span>
...
### <span class="color-sub-step">Step 7.1: Tracking time</span>
...
### <span class="color-sub-step">Step 7.2: Has enough time passed?</span>
...
### <span class="color-sub-step">Step 10.1: Add more fields</span>
...
### <span class="color-sub-step">Step 10.2: Add flip behavior</span>
...
### <span class="color-sub-step">Step 10.3: Run it</span>
