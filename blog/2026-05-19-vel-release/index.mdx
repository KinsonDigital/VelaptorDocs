...
<IssueOrPr repoName="Velaptor" issueOrPrNumber="1215" owner="KinsonDigital" urlText="View changes Read more on PR #1215"/>
...
- **Easy Opt-Out**: Telemetry is opted out as default.  This means you have to explicitly opt-in for use to collect data if you want to participate.
Look at the telemetry page for more information on how to opt-in.
