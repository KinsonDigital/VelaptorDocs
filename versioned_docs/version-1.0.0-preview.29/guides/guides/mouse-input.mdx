...
Go to the <a href="https://github.com/KinsonDigital/VelaptorTutorials/tree/api-v1.0.0-preview.29/MouseInput" target="_blank" className="link" rel="noopener noreferrer">MouseInput<OpenNewTab style={{paddingTop: '10', paddingLeft: '0.25%', width: '2%'}}/></a> tutorial project to see the source code for a fully working example of this guide.
:::
