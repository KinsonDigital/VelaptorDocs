...
- Go <OpenLinkNewTab url="https://github.com/KinsonDigital/VelaptorTutorials/blob/master/AtlasTextures/Content/Atlas/atlas.png" linkName="here"/> to download the <b><i>atlas.png</i></b> file.
- Go <OpenLinkNewTab url="https://github.com/KinsonDigital/VelaptorTutorials/blob/master/AtlasTextures/Content/Atlas/atlas.json" linkName="here"/> to download the <b><i>atlas.json</i></b> file.
