...
Go to the <TutorialLink projectName="Sounds" version="v1.0.0-preview.31"/> tutorial project to see the source code for a fully working example of this guide.
:::
...
sound <OpenLinkNewTab url="https://github.com/KinsonDigital/VelaptorDocs/raw/api-v1.0.0-preview.31/SampleProjects/Guides/Sounds/Content/Sounds/deep-consistency.ogg" linkName="here"/>.
