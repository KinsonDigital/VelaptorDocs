...
Go to the <a href="https://github.com/KinsonDigital/VelaptorTutorials/tree/api-v1.0.0-preview.30/KeyboardInput" target="_blank" className="link" rel="noopener noreferrer">KeyboardInput<OpenNewTab style={{paddingTop: '10', paddingLeft: '0.25%', width: '2%'}}/></a> guide project to see the source code for a fully working example of this guide.
:::
...
### <span class="color-sub-step">2.1: Creating the class fields</span>
...
### <span class="color-sub-step">2.2: Creating a keyboard object</span>
...
Click <Url href="https://refactoring.guru/design-patterns/factory-method" text="here" openInNewTab="true"/> for a great site about creational patterns.
:::
...
### <span class="color-sub-step">3.1: Key pressed detection</span>
...
### <span class="color-sub-step">3.2: Moving the window</span>
...
### <span class="color-sub-step">3.3: Changing the window size</span>
...
### <span class="color-sub-step">4.1: Getting the keyboard state</span>
...
### <span class="color-sub-step">4.2: Putting it all together</span>
...
### <span class="color-sub-step">4.3: Run it</span>
