...
Go to the <a href="https://github.com/KinsonDigital/VelaptorTutorials/tree/api-v1.0.0-preview.30/MouseInput" target="_blank" className="link" rel="noopener noreferrer">MouseInput<OpenNewTab style={{paddingTop: '10', paddingLeft: '0.25%', width: '2%'}}/></a> guide project to see the source code for a fully working example of this guide.
:::
...
### <span class="color-sub-step">2.2: Creating a mouse object</span>
...
### <span class="color-sub-step">3.1: Getting the mouse state</span>
...
### <span class="color-sub-step">3.2: Changing the window width</span>
...
### <span class="color-sub-step">3.3: Changing the window height</span>
...
### <span class="color-sub-step">3.4: Run it</span>
