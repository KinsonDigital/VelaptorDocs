...
<Url href="https://www.freecodecamp.org/news/the-difference-between-a-framework-and-a-library-bd133054023f/" test="Here" openInNewTab="true"/> is a good explanation of a framework vs a library.
:::
...
due to some of the low-level interactions with systems and libraries such as <Url href="https://www.opengl.org/" test="OpenGL" openInNewTab="true"/>, sound,
<Url href="https://freetype.org" test="FreeType" openInNewTab="true"/>, and other low-level interactions. These pieces are abstracted away to achieve high testability
...
- <Url href="https://discord.gg/qewu6fNgv7" test="Discord" openInNewTab="true"/>: For getting help, asking questions, conversation, and where we post updates and releases.
- <Url href="https://x.com/KDCoder" test="X" openInNewTab="true"/>: Where we post updates on releases as well as other software related topics.
- <Url href="https://github.com/kinsondigital" test="KinsonDigital" openInNewTab="true"/>: The KinsonDigital organization where you can find Velaptor and many other projects.

## Learn how to contribute

The Velaptor project is run and maintained by <Url href="https://x.com/KDCoder" test="Calvin Wilkinson"/> and <Url href="https://x.com/kswilky" test="Kristen Wilkinson"/>.
We work on this full-time and work hard to make Velaptor and all of the <Url href="https://github.com/KinsonDigital" test="KinsonDigital"/>
...
- Click <Url href="https://github.com/KinsonDigital/.github/blob/main/docs/CONTRIBUTING.md" test="here" openInNewTab="true"/> to learn how to contribute your time.
- Click <Url href="https://github.com/sponsors/KinsonDigital" test="here" openInNewTab="true"/> if you are interested in contributing your funds via one-time or recurring donations.

## License

Velaptor is a free and open-source project, released under the permissible <Url href="https://github.com/KinsonDigital/Velaptor/blob/preview/v1.0.0/LICENSE.md" test="MIT license" openInNewTab="true"/>
