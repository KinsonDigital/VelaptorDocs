...
:::info
If you are an experienced developer, you know what _**JSON**_ is.  For people who are learning and new to development,
click [here](https://www.youtube.com/watch?v=iiADhChRriM) for a great 10-minute video on what JSON is.
:::
...
Various tools out there give you the ability to easily create atlas textures and meta-data. A couple of examples are: [Texture Packer](https://www.codeandweb.com/texturepacker)
...
you want to load and when calling the `GetFrames()` method.  If you wanted to load the meta-data for the _**ship**_
