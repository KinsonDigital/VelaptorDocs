...
These copy file features are part of <Url href="https://visualstudio.microsoft.com/" text="Visual Studio" openInNewTab="true"/> and
<Url href="https://www.jetbrains.com/rider/" text="JetBrains Rider" openInNewTab="true"/>, not of Velaptor.
:::
