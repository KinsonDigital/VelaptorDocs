...
public class Score : IContentLoadable, IUpdatable, IDrawable
{
    ...
    /// <summary>
    /// Gets a value indicating whether or not the content has been loaded.
    /// </summary>
    ...
    public void Update(FrameTime frameTime) => this.textSize = this.font.Measure(this.scoreText);
