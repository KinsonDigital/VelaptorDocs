...
Go to the <GuideLink projectName="AtlasTextures" tagName="api-v1.0.0-preview.34"/> guide project to see the source code for a fully working example of this guide.
:::
...
1. <Url href="en.wikipedia.org/wiki/Texture_atlas" text="Wikipedia" openInNewTab="true"/>
