...
Go to the <a href="https://github.com/KinsonDigital/VelaptorTutorials/tree/api-v1.0.0-preview.30/Sounds" target="_blank" className="link" rel="noopener noreferrer">Sounds<OpenNewTab style={{paddingTop: '10', paddingLeft: '0.25%', width: '2%'}}/></a> guide project to see the source code for a fully working example of this guide.
:::
...
<table>
  <tr style={{ border: 'none' }}>
    <td style={{ border: 'none' }}>
		<Audio url="https://github.com/KinsonDigital/VelaptorTutorials/raw/api-v1.0.0-preview.30/Sounds/Content/Sounds/mario-jump.mp3"
        name="Mario Jump"/>
	</td>
    <td style={{ border: 'none' }}>
        <Audio url="https://github.com/KinsonDigital/VelaptorTutorials/raw/api-v1.0.0-preview.30/Sounds/Content/Sounds/metroid-ice-beam.mp3"
        name="Metroid Ice Beam"/>
	</td>
    <td style={{ border: 'none' }}>
		<Audio url="https://github.com/KinsonDigital/VelaptorTutorials/raw/api-v1.0.0-preview.30/Sounds/Content/Sounds/brinstar-music.mp3"
...
### <span class="color-sub-step">4.1: Get audio content</span>

You can provide whatever audio file you want, but if you don't have one, you can download the original guide project
sound <Url href="https://github.com/KinsonDigital/VelaptorTutorials/raw/api-v1.0.0-preview.30/Sounds/Content/Sounds/deep-consistency.ogg" text="here" openInNewtab="true"/>.

Play it to see if you like it.  😀
<Audio url="https://github.com/KinsonDigital/VelaptorTutorials/raw/api-v1.0.0-preview.30/Sounds/Content/Sounds/deep-consistency.ogg" />

### <span class="color-sub-step">4.2: Setup file as content</span>
...
### <span class="color-sub-step">4.3: Load the content</span>
...
### <span class="color-sub-step">4.4: Unload the content</span>
...
### <span class="color-sub-step">5.1: Displaying audo state</span>
...
### <span class="color-sub-step">5.2: Display time and instructions</span>
...
### <span class="color-sub-step">6.1: Keyboard state & key pressed</span>
...
### <span class="color-sub-step">6.2: Audio control with keyboard</span>
...
### <span class="color-sub-step">6.3: Finishing up</span>
