...
Go to the <a href="https://github.com/KinsonDigital/VelaptorTutorials/tree/api-v1.0.0-preview.30/RenderingText" target="_blank" className="link" rel="noopener noreferrer">RenderText<OpenNewTab style={{paddingTop: '10', paddingLeft: '0.25%', width: '2%'}}/></a> guide project to see the source code for a fully working example of this guide.
:::
...
## <span class="color-step">Step 2: Setup</span>
...
### <span class="color-sub-step">2.3: Content & rendering objects</span>
...
## <span class="color-step">Step 3: Loading and unload content</span>
...
### <span class="color-sub-step">3.1: Load the font</span>
...
### <span class="color-sub-step">3.2: Unload the font</span>
...
### <span class="color-sub-step">4.1: Setup batcher and renderer</span>
...
### <span class="color-sub-step">4.2: Run it!</span>
...
### <span class="color-sub-step">5.1: Class fields</span>
...
### <span class="color-sub-step">5.2:  Screen collision detection</span>
...
### <span class="color-sub-step">5.3: Update position with collision</span>
...
### <span class="color-sub-step">5.4: Changing the color</span>
...
### <span class="color-sub-step">5.5: Update the color</span>
...
### <span class="color-sub-step">5.6: Finishing up</span>
