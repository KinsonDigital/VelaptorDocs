...
Go to the <GuideLink projectName="RenderingTextures" tagName="v1.0.0-preview.32"/> guide project to see the source code for a fully working example of this guide.
:::
