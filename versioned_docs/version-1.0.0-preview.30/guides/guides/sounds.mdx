...
sound <OpenLinkNewTab url="https://github.com/KinsonDigital/VelaptorTutorials/raw/api-v1.0.0-preview.30/Sounds/Content/Sounds/deep-consistency.ogg" linkName="here"/>.
