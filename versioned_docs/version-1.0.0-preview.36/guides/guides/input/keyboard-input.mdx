...
Go to the <TutorialLink projectName="KeyboardInput" version="v1.0.0-preview.36"/> guide project to see the source code for a fully working example of this guide.
:::
...
Click <Url href="https://refactoring.guru/design-patterns/factory-method" text="here" openLinkNewTab="true"/> for a great site about creational patterns.
:::
