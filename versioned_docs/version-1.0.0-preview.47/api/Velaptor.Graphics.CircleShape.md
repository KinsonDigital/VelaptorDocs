...
```csharp
public record struct CircleShape : System.IEquatable<Velaptor.Graphics.CircleShape>
```

Implements [System\.IEquatable&lt;](https://learn.microsoft.com/en-us/dotnet/api/system.iequatable-1 'System\.IEquatable\`1')[CircleShape](Velaptor.Graphics.CircleShape.md 'Velaptor\.Graphics\.CircleShape')[&gt;](https://learn.microsoft.com/en-us/dotnet/api/system.iequatable-1 'System\.IEquatable\`1')
## Constructors
