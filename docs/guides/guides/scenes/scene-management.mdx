...
- <GuideLink projectName="ManagedScenes" tagName="api-v1.0.0-preview.36"/>
- <GuideLink projectName="UnmanagedScenes" tagName="api-v1.0.0-preview.35"/>
:::
...
<div className="flex flex-row items-center">
    <div className="w-1/3">
        <GuideImg className="justify-self-end"
                apiVersion="api-v1.0.0-preview.35"
    ...
    <div className="w-1/3">
        <GuideAudio apiVersion="api-v1.0.0-preview.35"
                    guideName="ManagedScenes"
                    name="Mario Jump"
