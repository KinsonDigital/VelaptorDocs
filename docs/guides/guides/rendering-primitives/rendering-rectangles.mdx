...
Go to the <GuideLink projectName="Rectangles" tagName="api-v1.0.0-preview.36"/> guide project to see the source code for a fully working example of this guide.
...
### <span className="color-sub-step">Size</span>

Let's give the rectangle a size.
