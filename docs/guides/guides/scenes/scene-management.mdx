...
_**Velaptor**_ comes with a scene manager, which performs tasks like loading and unloading content, updating, rendering, and determining how you transition between scenes. 
You can also build a custom scene manager for more control.  _**Velaptor**_ does not stand in your way!

:::note ABOUT THIS GUIDE
This guide will not show you how to manage scenes yourself.  That is a more advanced topic.  If you are interested, _**Velaptor**_ is open source!  You can see how we built the scene manager and how it works by looking at the source code.
:::
...
Refer to the [Project Setup](../project-setup) guide for more info.
:::

### <span className="color-sub-step">Step 1.2: Add content</span>

Follow the [Adding Content](../adding-content) guide to add the content below to your project.
...
:::tip GETTING IMAGES
Clicking the images above will take you to a GitHub page.  On the page, click the download button shown below.
...
### <span className="color-sub-step">Step 3.6: Change the behavior</span>
...
:::info REMINDER
You should have created the `Game` class in step [Step 1.1](./scene-management.mdx#step-11-setup-project).
:::
...
### <span className="color-sub-step">Step 4.3: Create the scenes</span>
...
<div className="flex justify-center">
    <div className="inline-flex justify-center border-5 border-solid rounded border-[#a99789]">
        <img src={require("@site/static/img/tutorials/guides/scenes/scene-manage.gif").default}/>
    </div>
</div>
