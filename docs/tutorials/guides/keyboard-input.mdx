...
and unfortunately, quitting the game.  Most of the time we don't want to quit and just keep playing. 😁

:::note project example
To see a complete working sample project of this tutorial, look at the <a target="_blank" rel="noopener" class="link" href="https://github.com/KinsonDigital/VelaptorTutorials/tree/master/KeyboardInput">
KeyboardInput<OpenNewTab style={{paddingTop: '10', paddingLeft: '0.25%', width: '2%'}}/></a> project in the <a target="_blank" rel="noopener" class="link" href="https://github.com/KinsonDigital/VelaptorTutorials">
