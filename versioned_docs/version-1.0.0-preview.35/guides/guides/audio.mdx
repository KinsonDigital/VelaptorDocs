...
Go to the <TutorialLink projectName="Audio" version="v1.0.0-preview.35"/> tutorial project to see the source code for a fully working example of this guide.
:::
...
<table>
  <tr style={{ border: 'none' }}>
    <td style={{ border: 'none' }}>
		<Audio url="https://github.com/KinsonDigital/VelaptorDocs/raw/api-v1.0.0-preview.35/SampleProjects/Guides/Audio/Content/Audio/mario-jump.mp3"
               name="Mario Jump"/>
	</td>
    <td style={{ border: 'none' }}>
        <Audio url="https://github.com/KinsonDigital/VelaptorDocs/raw/api-v1.0.0-preview.35/SampleProjects/Guides/Audio/Content/Audio/metroid-ice-beam.mp3" 
               name="Metroid Ice Beam"/>
	</td>
    <td style={{ border: 'none' }}>
		<Audio url="https://github.com/KinsonDigital/VelaptorDocs/raw/api-v1.0.0-preview.35/SampleProjects/Guides/Audio/Content/Audio/brinstar-music.mp3" 
