...
Go to the <GuideLink projectName="RenderingText" version="v1.0.0-preview.31"/> guide project to see the source code for a fully working example of this guide.
:::
