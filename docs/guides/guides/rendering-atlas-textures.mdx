...
Go to the <TutorialLink projectName="AtlasTextures" version="v1.0.0-preview.34"/> guide project to see the source code for a fully working example of this guide.
:::
...
1. <Url href="https://en.wikipedia.org/wiki/Texture_atlas" text="Wikipedia" openLinkNewTab="true"/>
2. <Url href="https://gamedevelopment.tutsplus.com/articles/using-texture-atlas-in-order-to-optimize-your-game--cms-26783" text="Game Dev Tuts Plus" openLinkNewTab="true"/>
3. <Url href="https://www.pinterest.com/pin/676877018967605282/" text="Examples" openLinkNewTab="true"/>
:::
...
:::info JSON
If you are new to **JSON**, click <Url href="https://www.youtube.com/watch?v=iiADhChRriM" text="here" openLinkNewTab="true"/> for a great 10-minute video.
:::
...
A couple of examples are: <Url href="https://www.codeandweb.com/texturepacker" text="Texture Packer" openLinkNewTab="true"/>
and <Url href="https://esotericsoftware.com/" text="Spine" openLinkNewTab="true"/>.
...
- Go <Url href="https://github.com/KinsonDigital/VelaptorDocs/blob/main/SampleProjects/Guides/AtlasTextures/Content/Atlas/atlas.png" text="here" openLinkNewTab="true"/> to download the <b><i>atlas.png</i></b> file.
- Go <Url href="https://github.com/KinsonDigital/VelaptorDocs/blob/main/SampleProjects/Guides/AtlasTextures/Content/Atlas/atlas.json" text="here" openLinkNewTab="true"/> to download the <b><i>atlas.json</i></b> file.
