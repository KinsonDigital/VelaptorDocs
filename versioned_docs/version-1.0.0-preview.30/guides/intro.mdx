...
<OpenLinkNewTab url="https://www.freecodecamp.org/news/the-difference-between-a-framework-and-a-library-bd133054023f/" linkName="Here"/> is a good explanation of a framework vs a library.
:::
...
due to some of the low-level interactions with systems and libraries such as <OpenLinkNewTab url="https://www.opengl.org/" linkName="OpenGL"/>, sound,
<OpenLinkNewTab url="https://freetype.org" linkName="FreeType"/>, and other low-level interactions. These pieces are abstracted away to achieve high testability
...
- <OpenLinkNewTab url="https://discord.gg/qewu6fNgv7" linkName="Discord"/>: For getting help, asking questions, conversation, and where we post updates and releases.
- <OpenLinkNewTab url="https://x.com/KDCoder" linkName="X"/>: Where we post updates on releases as well as other software related topics.
- <OpenLinkNewTab url="https://github.com/kinsondigital" linkName="KinsonDigital"/>: The KinsonDigital organization where you can find Velaptor and many other projects.

## Learn how to contribute

The Velaptor project is run and maintained by <OpenLinkNewTab url="https://x.com/KDCoder" linkName="Calvin Wilkinson"/> and <OpenLinkNewTab url="https://x.com/kswilky" linkName="Kristen Wilkinson"/>.
We work on this full-time and work hard to make Velaptor and all of the <OpenLinkNewTab url="https://github.com/KinsonDigital" linkName="KinsonDigital"/>
...
- Click <OpenLinkNewTab url="https://github.com/KinsonDigital/.github/blob/master/docs/CONTRIBUTING.md" linkName="here"/> to learn how to contribute your time.
- Click <OpenLinkNewTab url="https://github.com/sponsors/KinsonDigital" linkName="here"/> if you are interested in contributing your funds via one-time or recurring donations.

## License

Velaptor is a free and open-source project, released under the permissible <OpenLinkNewTab url="https://github.com/KinsonDigital/Velaptor/blob/release/v1.0.0/LICENSE.md" linkName="MIT license"/>
