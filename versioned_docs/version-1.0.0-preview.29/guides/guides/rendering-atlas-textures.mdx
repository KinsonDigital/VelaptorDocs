...
Go to the <TutorialLink projectName="AtlasTextures" version="v1.0.0-preview.24"/> tutorial project to see the source code for a fully working example of this guide.
:::
