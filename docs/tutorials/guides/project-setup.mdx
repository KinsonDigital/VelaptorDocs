...
To see a complete working project of this tutorial, look at the <a target="_blank" rel="noopener" class="link" href="https://github.com/KinsonDigital/VelaptorTutorials/tree/master/EmptyProject">
EmptyProject<OpenNewTab style={{paddingTop: '10', paddingLeft: '0.25%', width: '2%'}}/></a> project in the <a target="_blank" rel="noopener" class="link" href="https://github.com/KinsonDigital/VelaptorTutorials">
