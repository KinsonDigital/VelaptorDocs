...
familiar with local functions, you can read more about them <Url href="https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/classes-and-structs/local-functions" text="here" openLinkNewTab="true"/>.
```csharp
