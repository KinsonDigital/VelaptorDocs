...
Go to the <TutorialLink projectName="Sounds" version="v1.0.0-preview.32"/> guide project to see the source code for a fully working example of this guide.
:::
...
sound <Url href="https://github.com/KinsonDigital/VelaptorDocs/raw/api-v1.0.0-preview.32/SampleProjects/Guides/Sounds/Content/Sounds/deep-consistency.ogg" text="here" openInNewTab="true"/>.
