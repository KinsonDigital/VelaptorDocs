...
Go to the <TutorialLink projectName="Sounds" version="v1.0.0-preview.31"/> guide project to see the source code for a fully working example of this guide.
:::
...
<table>
  <tr style={{ border: 'none' }}>
    <td style={{ border: 'none' }}>
		<Audio url="https://github.com/KinsonDigital/VelaptorDocs/raw/api-v1.0.0-preview.31/SampleProjects/Guides/Sounds/Content/Sounds/mario-jump.mp3"
        name="Mario Jump"/>
	</td>
    <td style={{ border: 'none' }}>
        <Audio url="https://github.com/KinsonDigital/VelaptorDocs/raw/api-v1.0.0-preview.31/SampleProjects/Guides/Sounds/Content/Sounds/metroid-ice-beam.mp3"
        name="Metroid Ice Beam"/>
	</td>
    <td style={{ border: 'none' }}>
		<Audio url="https://github.com/KinsonDigital/VelaptorDocs/raw/api-v1.0.0-preview.31/SampleProjects/Guides/Sounds/Content/Sounds/brinstar-music.mp3"
...
sound <Url href="https://github.com/KinsonDigital/VelaptorDocs/raw/api-v1.0.0-preview.31/SampleProjects/Guides/Sounds/Content/Sounds/deep-consistency.ogg" text="here" openInNewtab="true"/>.

Play it to see if you like it.  😀
<Audio url="https://github.com/KinsonDigital/VelaptorDocs/raw/api-v1.0.0-preview.31/SampleProjects/Guides/Sounds/Content/Sounds/deep-consistency.ogg" />
