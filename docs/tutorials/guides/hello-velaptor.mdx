...
TODO: refer to adding content tutorial
...
These have to do with batching.  When we call `Begin()`, we are telling Velaptor that we are ready to start _**'batching'**_ all of our textures together.
