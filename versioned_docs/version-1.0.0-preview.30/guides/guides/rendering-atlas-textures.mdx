...
Go to the <a href="https://github.com/KinsonDigital/VelaptorTutorials/tree/api-v1.0.0-preview.30/AtlasTextures" target="_blank" className="link" rel="noopener noreferrer">AtlasTextures<OpenNewTab style={{paddingTop: '10', paddingLeft: '0.25%', width: '2%'}}/></a> guide project to see the source code for a fully working example of this guide.
:::
...
1. <OpenLinkNewTab url="https://en.wikipedia.org/wiki/Texture_atlas" linkName="Wikipedia"/>
2. <OpenLinkNewTab url="https://gamedevelopment.tutsplus.com/articles/using-texture-atlas-in-order-to-optimize-your-game--cms-26783" linkName="Game Dev Tuts Plus"/>
3. <OpenLinkNewTab url="https://www.pinterest.com/pin/676877018967605282/" linkName="Examples"/>
:::
...
:::info JSON
If you are new to **JSON**, click <OpenLinkNewTab url="https://www.youtube.com/watch?v=iiADhChRriM" linkName="here"/> for a great 10-minute video.
:::
...
A couple of examples are: <OpenLinkNewTab url="https://www.codeandweb.com/texturepacker" linkName="Texture Packer"/>
and <OpenLinkNewTab url="https://esotericsoftware.com/" linkName="Spine"/>.
...
- Go <OpenLinkNewTab url="https://github.com/KinsonDigital/VelaptorDocs/blob/main/SampleProjects/Guides/AtlasTextures/Content/Atlas/atlas.png" linkName="here"/> to download the <b><i>atlas.png</i></b> file.
- Go <OpenLinkNewTab url="https://github.com/KinsonDigital/VelaptorDocs/blob/main/SampleProjects/Guides/AtlasTextures/Content/Atlas/atlas.json" linkName="here"/> to download the <b><i>atlas.json</i></b> file.
...
### <span class="color-sub-step">Step 6.1: Load content</span>
...
Think of a <OpenLinkNewTab url="https://www.youtube.com/watch?v=Un-BdBSOGKY" linkName="flip book"/>.
