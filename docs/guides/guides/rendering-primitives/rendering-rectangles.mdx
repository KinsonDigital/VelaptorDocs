...
Go to the <GuideLink projectName="Rectangles" /> guide project to see the source code for a fully working example of this guide.
...
<NumberedList items={[
    <>The minimum value is <strong>0</strong>.  Any values below <strong>0</strong> will be set to <strong>0</strong>.</>,
