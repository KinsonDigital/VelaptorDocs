...
To see a complete working project of this tutorial, look at the [EmptyProject](https://github.com/KinsonDigital/VelaptorTutorials/tree/master/EmptyProject) project in the [VelaptorTutorials](https://github.com/KinsonDigital/VelaptorTutorials) repository.
:::
...
This is a great location to run game logic that can do anything you need.  One good example of something to use this for is to pause your game
automatically when minimized and to unpause when the window is maximized or restored.
...
{
    base.OnUnload(frameTime);
}
```

#### <span class="color-sub-step">Step 4.6: Run It</span>
