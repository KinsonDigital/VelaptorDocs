...
Go to the <TutorialLink projectName="Sounds" version="v1.0.0-preview.24" /> tutorial project to see the source code for a fully working example of this guide.
:::
...
**1.** Add a using statement at the top of the file to get access to some content extension methods.  Though these are not required,
