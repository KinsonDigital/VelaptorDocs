...
keyboard and mouse input, sound, and other common things required by games can take hours
(trust me, I know). With Velaptor, developing these sub-systems and features from scratch can take
hours when all you want to do is create.  This is where Velaptor can help!!
...
Joining our GitHub community is a great opportunity. Our community is always eager to welcome
...
We work on this full-time and work hard to make Velaptor and all of the [KinsonDigital](https://github.com/KinsonDigital) projects
as good as possible.  Any open-source developer will tell you that maintaining open-source projects are a ton of work.🥱  
