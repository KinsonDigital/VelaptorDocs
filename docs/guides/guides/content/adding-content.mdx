...
Once this is complete, download the Velaptor logo image and put it into the _**./Content/Graphics**_ folder.
...
<NumberedList items={[
    <><strong><em>Graphics:</em></strong> <em>Content/Graphics</em></>,
    <><strong><em>Texture Atlas:</em></strong> <em>Content/Atlas</em></>,
    <><strong><em>Audio:</em></strong> <em>Content/Audio</em></>
]} />
:::
