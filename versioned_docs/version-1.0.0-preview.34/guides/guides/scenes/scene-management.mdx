...
- <GuideLink projectName="ManagedScenes" tagName="v2024.05.17.070656"/>
- <GuideLink projectName="UnmanagedScenes" tagName="v2024.05.17.070656"/>
:::
...
<div className="flex flex-row items-center">
    <div className="w-1/3">
        <GuideImg className="justify-self-end"
                apiVersion="api-v1.0.0-preview.34"
    ...
    <div className="w-1/3">
        <GuideAudio apiVersion="api-v1.0.0-preview.34"
                    guideName="ManagedScenes"
                    name="Mario Jump"
