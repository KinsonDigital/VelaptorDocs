...
:::info Optional Step
If you are new to programming, you can skip this page and continue with the template-based quick start path.
:::
...
Create a new C# console application that targets the same .NET version as the guide samples (currently `net9.0`).
...
kind of content your game needs. This method is invoked one time when the application starts.

Create an override of the `Window.OnLoad()` method in the `Game` class as shown below:
