...
Go to the <a href="https://github.com/KinsonDigital/VelaptorTutorials/tree/api-v1.0.0-preview.29/Sounds" target="_blank" className="link" rel="noopener noreferrer">Sounds<OpenNewTab style={{paddingTop: '10', paddingLeft: '0.25%', width: '2%'}}/></a> tutorial project to see the source code for a fully working example of this guide.
:::
...
<table>
  <tr style={{ border: 'none' }}>
    <td style={{ border: 'none' }}>
		<Audio url="https://github.com/KinsonDigital/VelaptorTutorials/raw/api-v1.0.0-preview.29/Sounds/Content/Sounds/mario-jump.mp3"
			   name="Mario Jump"/>
	</td>
    <td style={{ border: 'none' }}>
		<Audio url="https://github.com/KinsonDigital/VelaptorTutorials/raw/api-v1.0.0-preview.29/Sounds/Content/Sounds/metroid-ice-beam.mp3"
			   name="Metroid Ice Beam"/>
	</td>
    <td style={{ border: 'none' }}>
		<Audio url="https://github.com/KinsonDigital/VelaptorTutorials/raw/api-v1.0.0-preview.29/Sounds/Content/Sounds/brinstar-music.mp3"
...
sound [here](https://github.com/KinsonDigital/VelaptorTutorials/raw/api-v1.0.0-preview.29/Sounds/Content/Sounds/deep-consistency.ogg).

Play it to see if you like it.  😀
<Audio url="https://github.com/KinsonDigital/VelaptorTutorials/raw/api-v1.0.0-preview.29/Sounds/Content/Sounds/deep-consistency.ogg"/>
