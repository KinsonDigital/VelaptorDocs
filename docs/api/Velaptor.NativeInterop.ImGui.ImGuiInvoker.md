...
```csharp
public sealed class ImGuiInvoker : Velaptor.NativeInterop.ImGui.IImGuiInvoker
```

Inheritance [System\.Object](https://learn.microsoft.com/en-us/dotnet/api/system.object 'System\.Object') → ImGuiInvoker
