...
## <span className="color-step" className="size-20">Step 2: Create Scene A</span>
...
### <span className="color-sub-step">Step 2.2: Override methods</span>
...
### <span className="color-sub-step">Step 3.4: Load the scene content</span>
...
### <span className="color-sub-step">Step 3.5: Unloading the content</span>
...
### <span className="color-sub-step">Step 3.6: Add something interesting</span>
...
### <span className="color-sub-step">Step 3.7: Add some instructions</span>
