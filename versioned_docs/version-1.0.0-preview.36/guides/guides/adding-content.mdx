...
These copy file features are part of <Url href="https://visualstudio.microsoft.com/" text="Visual Studio" openLinkNewTab="true"/> and
<Url href="https://www.jetbrains.com/rider/" text="JetBrains Rider" openLinkNewTab="true"/>, not of Velaptor.
:::
