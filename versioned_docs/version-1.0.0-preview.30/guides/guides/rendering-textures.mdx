...
Go to the <a href="https://github.com/KinsonDigital/VelaptorTutorials/tree/api-v1.0.0-preview.30/RenderingTextures" target="_blank" className="link" rel="noopener noreferrer">RenderTextures<OpenNewTab style={{paddingTop: '10', paddingLeft: '0.25%', width: '2%'}}/></a> guide project to see the source code for a fully working example of this guide.
:::
...
### <span class="color-sub-step">Step 2.3: Create loader, batcher, & renderer</span>
