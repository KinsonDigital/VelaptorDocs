...
sound <OpenLinkNewTab url="https://github.com/KinsonDigital/VelaptorDocs/raw/api-v1.0.0-preview.34/SampleProjects/Guides/Sounds/Content/Sounds/deep-consistency.ogg" linkName="here"/>.
