...
Go to the <a href="https://github.com/KinsonDigital/VelaptorTutorials/tree/api-v1.0.0-preview.29/AtlasTextures" target="_blank" className="link" rel="noopener noreferrer">AtlasTextures<OpenNewTab style={{paddingTop: '10', paddingLeft: '0.25%', width: '2%'}}/></a> tutorial project to see the source code for a fully working example of this guide.
:::
...
:::info JSON
Don't know what _**JSON**_ is? If new to JSOn, click [here](https://www.youtube.com/watch?v=iiADhChRriM) for a great 10-minute video.
:::
...
A couple of examples are: [Texture Packer](https://www.codeandweb.com/texturepacker)
...
Plans are in the works to add _**Texture Packer**_ integration. One option you have is to create a tool to
...
- Go <a target="\_blank" href="https://github.com/KinsonDigital/VelaptorDocs/blob/main/SampleProjects/Guides/AtlasTextures/Content/Atlas/atlas.png">here</a> to download the <b><i>atlas.png</i></b> file.
- Go <a target="\_blank" href="https://github.com/KinsonDigital/VelaptorDocs/blob/main/SampleProjects/Guides/AtlasTextures/Content/Atlas/atlas.json">here</a> to download the <b><i>atlas.json</i></b> file.
