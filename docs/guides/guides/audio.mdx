...
Go to the <TutorialLink projectName="Audio" version="v1.0.0-preview.34"/> tutorial project to see the source code for a fully working example of this guide.
:::
...
<table>
  <tr style={{ border: 'none' }}>
    <td style={{ border: 'none' }}>
		<Audio url="https://github.com/KinsonDigital/VelaptorDocs/raw/main/SampleProjects/Guides/Audio/Content/Audio/mario-jump.mp3"
        name="Mario Jump"/>
	</td>
    <td style={{ border: 'none' }}>
        <Audio url="https://github.com/KinsonDigital/VelaptorDocs/raw/main/SampleProjects/Guides/Audio/Content/Audio/metroid-ice-beam.mp3"
        name="Metroid Ice Beam"/>
	</td>
    <td style={{ border: 'none' }}>
		<Audio url="https://github.com/KinsonDigital/VelaptorDocs/raw/main/SampleProjects/Guides/Audio/Content/Audio/brinstar-music.mp3"
...
create the audio loader to load audio content.
...
## <span class="color-step">Step 4: Load and unload the content</span>
...
1. <OpenLinkNewTab url="https://github.com/KinsonDigital/VelaptorDocs/raw/main/SampleProjects/Guides/Audio/Content/Audio/brinstar-music.ogg" linkName="Download Metroid Brinstar"/>.
    <Audio url="https://github.com/KinsonDigital/VelaptorDocs/raw/main/SampleProjects/Guides/Audio/Content/Audio/brinstar-music.ogg" />
2. <OpenLinkNewTab url="https://github.com/KinsonDigital/VelaptorDocs/raw/main/SampleProjects/Guides/Audio/Content/Audio/deep-consistency.ogg" linkName="Download Deep Consistency"/>.
    <Audio url="https://github.com/KinsonDigital/VelaptorDocs/raw/main/SampleProjects/Guides/Audio/Content/Audio/deep-consistency.ogg" />
...
### <span class="color-sub-step">Step 4.3: Load the content</span>
...
### <span class="color-sub-step">Step 4.4: Unload the content</span>
...
familiar with local functions, you can read more about them <OpenLinkNewTab url="https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/classes-and-structs/local-functions" linkName="here"/>.
```csharp
...
<img style={{ width: '75%' }} src={require('@site/static/img/tutorials/guides/sounds/audio-window.png').default} alt="Example banner" />
