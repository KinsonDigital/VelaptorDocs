...
<NumberedList items={[
    ...
    <>Removal of internal use of deprecated <strong><em>Velaptor UI Control API</em></strong>.</>,
...
<NumberedList items={[
    <>
        SimpleInjector updated from <strong><em>v5.4.3</em></strong> to <strong><em>v5.4.4</em></strong>.
        <ul>
            This is used for all of our dependency injection needs.
        </ul>
    </>,
    <>
        SixLabors.ImageSharp updated from <strong><em>v3.1.1</em></strong> to <strong><em>v3.1.2</em></strong>.
        <ul>
