...
Go to the <GuideLink projectName="EmptyProject" tagName="api-v1.0.0-preview.38"/> guide project to see the source code for a fully working example of this guide.
:::
...
Create a new C# console application using dotnet version specified in the `EmptyProject.csproj`, look after property group `<TargetFramework>`.
