...
Games cannot be a game without having the ability to render textures.  This guide will show you how to render non-animating
...
You can download the Velaptor mascot [here](../../../static/img/downloads/velaptor-mascot.png).  
