...
its current state on Windows, Linux and macOS. We are constantly adding improvements and there are plans for Velaptor to run on other platforms such as
Android, and iOS.
:::
...
due to some of the low-level interactions with systems and libraries such as [WebGPU](https://webgpu.org/), sound,
...
- Refer to the support section below if you are interested in contributing your funds via one-time or recurring donations.

## Support Velaptor

Velaptor is a free, open-source framework that is independently developed and maintained.
If it saves you development time or helps you ship your game, consider supporting its ongoing
maintenance and roadmap with a one-time or recurring donation.

- [GitHub Sponsors](https://github.com/sponsors/KinsonDigital): One-time or recurring support.
- [Open Collective](https://opencollective.com/kinsondigital): One-time or recurring support.
- [Ko-fi](https://ko-fi.com/kinsondigital): One-time or recurring support.

Current funding goals and how donations are used are tracked in the
[project README](https://github.com/KinsonDigital/Velaptor/blob/preview/README.md).
