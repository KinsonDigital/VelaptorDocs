...
Go to the <GuideLink projectName="MouseInput" tagName="api-v1.0.0-preview.35"/> guide project to see the source code for a fully working example of this guide.
:::
