...
Go to the <TutorialLink projectName="Sounds" version="v1.0.0-preview.30" /> tutorial project to see the source code for a fully working example of this guide.
:::
...
Create the required class fields that will be used to get the keyboard input, hold the previous keyboard state for
...
sound <OpenLinkNewTab url="https://github.com/KinsonDigital/VelaptorTutorials/raw/master/Sounds/Content/Sounds/deep-consistency.ogg" linkName="here"/>.
