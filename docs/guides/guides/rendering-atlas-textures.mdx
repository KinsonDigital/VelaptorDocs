...
<NumberedList items={[
    <Url href="https://en.wikipedia.org/wiki/Texture_atlas" text="Wikipedia" openInNewTab={true} />,
    <Url href="gamedevelopment.tutsplus.com/articles/using-texture-atlas-in-order-to-optimize-your-game--cms-26783" text="Game Dev Tuts Plus" openInNewTab={true} />,
    <Url href="www.pinterest.com/pin/676877018967605282/" text="Examples" openInNewTab={true} />
]}/>
:::
...
<video autoPlay loop muted playsInline loading="lazy">
    <source src={require("@site/static/img/guides/rendering-atlas-textures/flame.mp4").default} type="video/mp4" />
</video>
