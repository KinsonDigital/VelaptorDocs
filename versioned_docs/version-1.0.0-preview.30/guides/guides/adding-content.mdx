...
These copy file features are part of <OpenLinkNewTab url="https://visualstudio.microsoft.com/" linkName="Visual Studio"/> and
<OpenLinkNewTab url="https://www.jetbrains.com/rider/" linkName="JetBrains Rider"/>, not of Velaptor.
:::
