...
Go to the <GuideLink projectName="Audio" tagName="api-v1.0.0-preview.35"/> guide project to see the source code for a fully working example of this guide.
:::
...
<table>
  <tr style={{ border: 'none' }}>
    <td style={{ border: 'none' }}>
        <GuideAudio apiVersion="api-v1.0.0-preview.35" guideName="Audio" audioFileName="mario-jump.mp3" name="Mario Jump"/>
	</td>
    <td style={{ border: 'none' }}>
        <GuideAudio apiVersion="api-v1.0.0-preview.35" guideName="Audio" audioFileName="metroid-ice-beam.mp3" name="Metroid Ice Beam"/>
	</td>
    <td style={{ border: 'none' }}>
        <GuideAudio apiVersion="api-v1.0.0-preview.35" guideName="Audio" audioFileName="brinstar-music.mp3" name="Metroid Brinstar Music"/>
	</td>
  </tr>
</table>
...
<img style={{width: '35%'}} src={require('@site/static/img/tutorials/guides/audio/download-audio.gif').default} alt="Example banner"/>
