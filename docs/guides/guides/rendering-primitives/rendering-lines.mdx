...
Go to the <GuideLink projectName="Lines" /> guide project to see the source code for a fully working example of this guide.
...
To render the line, we must create an `IShapeRenderer` renderer.
...
protected void OnDraw(FrameTime frameTime)
{
    ...
    this.shapeRenderer.Render(line);
...
of the `IShapeRenderer.RenderLine` method overloads.

```csharp showLineNumbers
this.shapeRenderer.RenderLine(new Vector2(10, 20), new Vector2(30, 40));

// or

this.shapeRenderer.RenderLine(new Vector2(10, 20), new Vector2(30, 40), 14);

// or

this.shapeRenderer.RenderLine(new Vector2(10, 20), new Vector2(30, 40), Color.MediumSeaGreen);

// or

this.shapeRenderer.RenderLine(new Vector2(10, 20), new Vector2(30, 40), Color.MediumSeaGreen, 14);
```
